...
public class ArraysExample2 {
    ...
    public static void main(String[] args) {
        ...
        IntStream a = Stream.of(number).flatMapToInt(i->Arrays.stream(i));
        List<Integer> list  = Stream.of(number).flatMapToInt(i->Arrays.stream(i)).boxed().collect(Collectors.toList()); 
